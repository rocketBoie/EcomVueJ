...
<template>
    ...
    <div class="w-full pl-8 pr-8 pt-8 pb-8 flex items-center bg-gray-100">
        <Swiper :modules="[Navigation, Autoplay]" :slides-per-view="4" loop :space-between="20"
            :autoplay="{ delay: 1500, disableOnInteraction: false, pauseOnMouseEnter: true }" navigation
            class="mySwiper">
            <SwiperSlide v-for="product in products" :key="product.id" class="bg-gray-200 bg-opacity-10">
